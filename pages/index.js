...
import StoragePermissionsDemo from '../src/components/StoragePermissionsDemo';
import DatabasePermissionsDemo from '../src/components/DatabasePermissionsDemo';
        ...
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ 
                ...
                <button
                    ...
                    style={{
                        background: activeTab === 'database' ? '#4CAF50' : 'transparent',
                        color: activeTab === 'database' ? 'white' : '#333',
                        border: 'none',
                        padding: '10px 20px',
                        borderRadius: '8px 8px 0 0',
                        cursor: 'pointer',
        ...
        <div>
            <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '15px', marginTop: '15px' }}>
                    ...
                    <div style={{ background: 'white', padding: '15px', borderRadius: '8px', border: '1px solid #ddd' }}>
                        <h3>�️ Database Permissions</h3>
                        <ul>
                            <li>DynamoDB table access control</li>
                            <li>Owner-based record access</li>
                            <li>Group-based data filtering</li>
            ...
            <div style={{
                ...
                <ol>
                    ...
                    <li><strong>Test Database:</strong> Use "🗄️ Database Permissions" to interact with DynamoDB tables and see permission enforcement</li>
                    <li><strong>Test API Access:</strong> Use "📝 Posts & API" to create and manage posts with different permission levels</li>
                    <li><strong>Admin Features:</strong> {userGroups.includes('Admins') ? 'You have admin access - try uploading to admin/ folders and viewing admin logs!' : 'Sign in as an admin to see additional features'}</li>
